...
\begin{figure}[t]
    ...
    \begin{subfigmatrix}{3}
        \subfigure[CLT による近似]{\includegraphics[]{figs/hist-clt.pdf}}
        \subfigure[Box-Muller 法]{\includegraphics[]{figs/hist-box-muller.pdf}}
        \subfigure[Polar 法]{\includegraphics[]{figs/hist-polar.pdf}}
        \subfigure[Kinderman 法]{\includegraphics[]{figs/hist-kinderman.pdf}}
        \subfigure[Monty-Python 法]{\includegraphics[]{figs/hist-montypython.pdf}}
        \subfigure[Ziggurat 法]{\includegraphics[]{figs/hist-ziggurat.pdf}}
    \end{subfigmatrix}
